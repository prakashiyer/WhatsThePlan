package com.theiyer.whatstheplan;
	...
	public class CenterGridAdapter extends BaseAdapter {
		...
		public CenterGridAdapter(Activity a, List<Map<String, Center>> d) {
			activity = a;
			data = d;
		...
		public CenterGridAdapter(Activity a) {
			activity = a;
			inflater = (LayoutInflater) activity
					.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			for (Entry<String, Center> entry : selectedMap.entrySet()) {
				...
				textView.setText(healthCenter.getName());
				...
				byte[] image = healthCenter.getImage();
				if (image != null) {
