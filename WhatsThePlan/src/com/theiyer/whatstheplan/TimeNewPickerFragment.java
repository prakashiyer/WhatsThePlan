	...
	public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
		...
		if (time.equals("end")) {
			...
			if (odate != null && !odate.equals("") && otime != null
				...
				c.set(Calendar.HOUR_OF_DAY, Integer.valueOf(oHr));
				c.set(Calendar.MONTH, Integer.valueOf(omin));
				...
				nc.set(Calendar.HOUR_OF_DAY, Integer.valueOf(oHr));
				nc.set(Calendar.MONTH, Integer.valueOf(omin));
